...
export const ja: Dict = {
  ...
  rewards: {
    ...
    catDish: "料理",
    catDrink: "ドリンク",
    memberTitle: "都 Miyako Club",
    currentPoints: "保有ポイント",
    pointsUnit: "pt",
    pts: "pt",
    needMore: (pts, nextTier) => `次の${nextTier}まであと${pts}pt`,
    maxTierReached: "最高ランクの会員様です",
    redeemTitle: "この特典と交換しますか？",
    redeemCost: (cost) => `必要ポイント：${cost} pt`,
    balanceAfter: (bal) => `交換後の残高：${bal} pt`,
    confirmRedeem: "交換を確定する",
    cancel: "キャンセル",
    redeemSuccess: "特典と交換しました！",
    yourVoucherCode: "あなたの優待コード",
    useAtMenu: "お品書きですぐ使う",
    useCodeHint: "お会計時にスタッフにご提示いただくか、ご注文時にご入力ください",
    notEnoughPoints: "ポイントが不足しています",
    claimQuest: "獲得",
    claimed: "獲得済み",
    historyEmpty: "ポイント履歴はまだありません",
    historyTitle: "ポイント履歴",
    memberBarcodeHint: "会員バーコード",
    memberQrHint: "会員QRコード",
    close: "閉じる",
  },
  ...
  butcher: {
    title: "和牛精肉店",
    shopName: "宮古 和牛精肉店",
    subtitle: "ご希望に合わせてカットする極上精肉",
    desc: "厳選されたA5ランク日本産黒毛和牛とUSプライムビーフを毎日切り立てでご提供。保冷剤入り真空パックでお届け。",
    serviceTag: "A5和牛専門店",
    guarantee1Title: "ご希望の厚さにカット",
    guarantee1Desc: "ステーキ用2-3cm、焼肉用、しゃぶしゃぶ用1.5mmスライス無料対応",
    guarantee2Title: "保冷剤入り真空パック",
    guarantee2Desc: "衛生的な真空包装で、新鮮な風味と冷温を損なわずお届けします",
    guarantee3Title: "市内2時間スピード配達",
    guarantee3Desc: "店舗からご家庭の食卓まで徹底した温度管理で迅速にお届け",
    guarantee4Title: "100%産地証明書付き",
    guarantee4Desc: "正規輸入された日本産A5和牛。仕入れロットごとの原産地証明書を完備",
  },
};
