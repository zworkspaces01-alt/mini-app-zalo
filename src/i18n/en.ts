...
export const en: Dict = {
  ...
  rewards: {
    ...
    tabGifts: "Redeem Rewards",
    tabTiers: "Tier Benefits",
    tabQuests: "Earn Points",
    ...
    currentPoints: "Accumulated Points",
    pointsUnit: "pts",
    pts: "pts",
    needMore: (pts, nextTier) => `${pts} pts needed to reach ${nextTier}`,
    maxTierReached: "You have reached the highest membership tier",
    redeemTitle: "Redeem this reward?",
    redeemCost: (cost) => `Cost: ${cost} points`,
    balanceAfter: (bal) => `Balance after: ${bal} points`,
    confirmRedeem: "Confirm Redeem",
    cancel: "Cancel",
    redeemSuccess: "Redeemed Successfully!",
    yourVoucherCode: "Your voucher code",
    useAtMenu: "Use now at Menu",
    useCodeHint: "Show this code to staff or enter when ordering",
    notEnoughPoints: "Not enough reward points",
    claimQuest: "Claim",
    claimed: "Claimed",
    historyEmpty: "No point transactions yet",
    historyTitle: "Points History",
    memberBarcodeHint: "Member Barcode",
    memberQrHint: "Member QR Code",
    close: "Close",
  },
  ...
  butcher: {
    ...
    subtitle: "Custom-cut fresh gourmet meats",
    desc: "Japanese A5 Wagyu & US Prime beef cut fresh daily. Vacuum-sealed with thermal gel ice packs for guaranteed freshness.",
    serviceTag: "A5 Wagyu Specialist",
    guarantee1Title: "Custom Cutting",
    guarantee1Desc: "Complimentary custom thickness: 2-3cm Steak, Yakiniku, or 1.5mm Shabu hotpot slice",
    guarantee2Title: "Thermal Gel Packing",
    guarantee2Desc: "Vacuum-sealed sterile tray packaging maintaining deep chill freshness",
    guarantee3Title: "2-Hour Express Delivery",
    guarantee3Desc: "Fast doorstep delivery with cold-chain standards straight to your dining table",
    guarantee4Title: "100% Certified Origin",
    guarantee4Desc: "Officially imported Japanese A5 Wagyu with individual batch authenticity certificates",
  },
};
